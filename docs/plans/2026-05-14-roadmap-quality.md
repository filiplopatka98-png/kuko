...
- [ ] **Keyboard navigation:** šípky pre pohyb medzi dňami, Home/End pre prvý/posledný v týždni, PageUp/PageDown pre mesiac, Enter pre výber
- [ ] **aria-selected** na vybraný deň
- [ ] **aria-disabled** na nedostupné dni (closed_day, full, past) — momentálne `disabled` atribút, treba doplniť ARIA
- [ ] **aria-label per cell** — „Streda 15. máj, dostupné, 19 voľných časov" / „Sobota 18. máj, plne obsadené"
- [ ] **aria-live region** — po výbere dňa announce „Vybraný 15. máj. 19 voľných časov pod kalendárom."
...
- [ ] **favicon.ico** — multi-resolution (16×16, 32×32, 48×48) v jednom .ico súbore. Cez https://realfavicongenerator.net/ alebo `imagemagick`
...
- [ ] **Apple touch icon** — `apple-touch-icon.png` 180×180 (homepage save to iPhone home screen)
- [ ] **Android Chrome icons** — 192×192 a 512×512 PNG pre add-to-homescreen
...
- [ ] **HTML refs** — `<link rel="icon" href="/favicon.svg" type="image/svg+xml">`, `<link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">`, atď.

### F2. Web App Manifest (priority: low, ~½ dňa)
- [ ] **`/manifest.webmanifest`** — JSON s name, short_name, icons array, theme_color, background_color, display: "standalone", start_url: "/"
...
- [ ] **og-cover.jpg** — 1200×630 dedikovaný OG obrázok (nie reuse hero.jpg ktorá je vyšších rozmerov a iného aspect ratia). KUKO logo + dúha + URL
