  ...
  <div class="container">
    ...
    <div class="cards-grid">
      <div class="card card--blue">
        ...
        <div class="card__body"><?= \Kuko\Content::get('about.card1', '<strong>Bezpečný, čistý a hravý priestor,</strong><br>kde sa deti môžu vyšantiť, objavovať a tráviť čas aktívne.') ?></div>
      </div>
      <div class="card card--peach">
        ...
        <div class="card__body"><?= \Kuko\Content::get('about.card2', 'Rodičia si zatiaľ môžu vychutnať <strong>kvalitnú kávu a chvíľku oddychu</strong> v príjemnom prostredí.') ?></div>
      </div>
      <div class="card card--yellow">
        <img class="card__icon" src="<?= e(\Kuko\Asset::url('/assets/icons/friendship.svg')) ?>" alt="" aria-hidden="true" width="64" height="64">
        <div class="card__body"><?= \Kuko\Content::get('about.card3', '<strong>Ideálne miesto na stretnutie</strong> s priateľmi či rodinou, alebo len chvíľu pre seba, zatiaľ čo sa deti zabavia.') ?></div>
      </div>
      <div class="card card--purple">
        <img class="card__icon" src="<?= e(\Kuko\Asset::url('/assets/icons/balloons.svg')) ?>" alt="" aria-hidden="true" width="64" height="64">
        <div class="card__body"><?= \Kuko\Content::get('about.card4', '<strong>Organizujeme aj detské oslavy,</strong> ktoré pripravíme s dôrazom na radosť detí a bezstarostnosť pre rodičov.') ?></div>
