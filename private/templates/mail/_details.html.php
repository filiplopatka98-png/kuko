...
<table style="border-collapse:collapse;width:100%;margin:1rem 0;font-size:0.95rem">
  ...
  <tr style="background:#faf5fc"><td style="padding:6px 10px;vertical-align:top;color:#777"><strong>Telefón</strong></td><td style="padding:6px 10px"><a href="tel:<?= e(preg_replace('/\s+/', '', (string) ($r['phone'] ?? ''))) ?>" style="color:#D88BBE"><?= e((string) ($r['phone'] ?? '')) ?></a></td></tr>
  <tr><td style="padding:6px 10px;vertical-align:top;color:#777"><strong>E-mail</strong></td><td style="padding:6px 10px"><a href="mailto:<?= e((string) ($r['email'] ?? '')) ?>" style="color:#D88BBE"><?= e((string) ($r['email'] ?? '')) ?></a></td></tr>
