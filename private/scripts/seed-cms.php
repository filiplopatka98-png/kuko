...
$blocks = [
    ...
    ['about.card2.body', 'O nás — karta 2 text', 'text', 'Rodičia si zatiaľ môžu vychutnať kvalitnú kávu a chvíľku oddychu v príjemnom prostredí.'],
    ['about.card3.title', 'O nás — karta 3 nadpis', 'text', 'Ideálne miesto na stretnutie'],
    ['about.card3.body', 'O nás — karta 3 text', 'text', 'Ideálne miesto na stretnutie s priateľmi či rodinou, alebo len chvíľu pre seba, zatiaľ čo sa deti zabavia.'],
    ['about.card4.title', 'O nás — karta 4 nadpis', 'text', 'Organizujeme aj detské oslavy,'],
    ['about.card4.body', 'O nás — karta 4 text', 'text', 'Organizujeme aj detské oslavy, ktoré pripravíme s dôrazom na radosť detí a bezstarostnosť pre rodičov.'],
